...
class TiendaController extends Controller
{
    ...
    public function politicasAction(Request $request)
    {
        ...
        return $this->render('SelnetTiendaOnlineBundle:Pages:politicas.tienda.html.twig', array(
    ...
    public function personalizarTiendaAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($tienda)->add("file", "file")->add("titulo", "text")->add("mensaje", "textarea")->add("anuncio", "textarea")->getForm();
        ...
        return $this->render('SelnetTiendaOnlineBundle:Pages:personaliza.tienda.html.twig', array(
            "form" => $form->createView(),
